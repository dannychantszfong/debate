...
class CosyVoiceFrontEnd:
    ...
    def __init__(self,
        ...
        speech_tokenizer_option = onnxruntime.SessionOptions()
        # On Windows, ORT_ENABLE_ALL can OOM during session initialization for speech_tokenizer_v2/v3.
        speech_tokenizer_option.graph_optimization_level = onnxruntime.GraphOptimizationLevel.ORT_DISABLE_ALL
        speech_tokenizer_option.intra_op_num_threads = 1
        speech_tokenizer_providers = ["CPUExecutionProvider"] if os.name == 'nt' else [
            "CUDAExecutionProvider" if torch.cuda.is_available() else "CPUExecutionProvider"
        ]
        self.speech_tokenizer_session = onnxruntime.InferenceSession(speech_tokenizer_model, sess_options=speech_tokenizer_option,
